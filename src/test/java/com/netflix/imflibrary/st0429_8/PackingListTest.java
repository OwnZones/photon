...
public class PackingListTest
{
    ...
    {
        FileLocator inputFile = TestHelper.findResourceByPath("test_mapped_file_set/PKL_51edd4be-4506-494d-a58e-516553055c33.xml");
    ...
    {
        FileLocator inputFile = TestHelper.findResourceByPath("PKL_2067_2_2016.xml");
        PackingList packingList = new PackingList(FileLocator.fromLocation(inputFile.toURI()));
